...
module.exports.run = async (client, message, args) => {
  ...
  if (!message.member.roles.cache.has("789777544391819265")) //register krdşm
  ...
  let erkek = '789779344951345202' //erkek 1. rol
...
Alınan Rol;** <@&${kayıtsız}>`);
  ...
  message.guild.channels.cache.get("789782806195863552").send(`${user} Adlı Kullanıcı Aramıza Katıldı!**`)//general chat ıd
